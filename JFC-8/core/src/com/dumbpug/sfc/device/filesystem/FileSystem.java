package com.dumbpug.sfc.device.filesystem;
...
public class FileSystem {
     ...
     * @throws com.dumbpug.sfc.device.filesystem.InvalidPathException The exception thrown when the requested path is not valid.
     */
    public void changeDirectory(String path) throws com.dumbpug.sfc.device.filesystem.InvalidPathException {
        ...
        if (!this.isPathValid(targetDirectoryFile.toPath())) {
            throw new com.dumbpug.sfc.device.filesystem.InvalidPathException(this.rootDir.toPath().relativize(targetDirectoryFile.toPath()).normalize().toString());
        }
