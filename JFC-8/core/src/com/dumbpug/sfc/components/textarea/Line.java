...
import com.dumbpug.sfc.components.textarea.Column;
...
public class Line {
     ...
     */
    private ArrayList<com.dumbpug.sfc.components.textarea.Column> columns = new ArrayList<com.dumbpug.sfc.components.textarea.Column>();
    ...
    public Line() {
        ...
        columns.add(new com.dumbpug.sfc.components.textarea.Column());
    }
    ...
    public void addCharacter(char character, int column) {
        ...
        this.columns.add(column, new com.dumbpug.sfc.components.textarea.Column(character));
    }
